...
public class AdapterSerchResults extends ArrayAdapter<String> {
    ...
    public CustomAdapter(Context context, String[] imgURL, String[] name, String [] price, String[] lat_rad, String[] long_rad) {
        super(context, R.layout.search_result_model, description);
